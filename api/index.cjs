...
// prisma-saas/generated/saas-client/runtime/library.js
var require_library = __commonJS({
  "prisma-saas/generated/saas-client/runtime/library.js"(exports, module) {
    "use strict";
...
// prisma-saas/generated/saas-client/index.js
var require_saas_client = __commonJS({
  "prisma-saas/generated/saas-client/index.js"(exports2) {
    ...
    var config2 = {
      ...
      "inlineSchemaHash": "ea05b1cd1b69c4e99c204c3fea00445f9e3b75eeb518f4b807459d247138eb57",
      "copyEngine": true
    };
    var fs2 = require("fs");
    ...
    if (!fs2.existsSync(path.join(__dirname, "schema.prisma"))) {
      const alternativePaths = [
        "prisma-saas/generated/saas-client",
        "generated/saas-client"
      ];
    ...
    path.join(process.cwd(), "prisma-saas/generated/saas-client/query_engine-windows.dll.node");
    path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
    path.join(process.cwd(), "prisma-saas/generated/saas-client/libquery_engine-rhel-openssl-3.0.x.so.node");
    path.join(__dirname, "schema.prisma");
    path.join(process.cwd(), "prisma-saas/generated/saas-client/schema.prisma");
  }
});
...
router.patch("/organizations/:id", async (req, res) => {
  try {
    const { name, plan, suspended, billingDueDate, phone, email, address } = req.body;
    const updateData = {};
    if (name !== void 0) updateData.name = name.trim();
    if (plan !== void 0) updateData.plan = plan;
    if (suspended !== void 0) updateData.plan = suspended ? "suspended" : "free";
...
var corsOrigins = process.env.SAAS_CORS_ORIGINS?.split(",").map((o) => o.trim()).filter(Boolean) ?? [];
app.use(
...
app.use((req, _res, next) => {
  ...
  if (typeof pathParam === "string" && pathParam) {
    const qs2 = { ...req.query || {} };
    delete qs2.__path;
    const search = new URLSearchParams(qs2).toString();
  ...
  try {
    ...
    if (user.organizationId) {
      ...
      if (organization) {
        ...
        const trialExpired = plan === "free" && trialEndsAt && trialEndsAt < /* @__PURE__ */ new Date();
        if (plan === "suspended") {
          return res.status(403).json({
            message: "Account suspended. Please contact support to restore access."
          });
